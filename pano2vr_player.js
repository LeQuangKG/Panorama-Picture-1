...
function ga(h, y, k) {
    ...
    l.length = function () {
        return Math.sqrt(l.x * l.x + l.y * l.y + l.b *
            l.b)
    };
    l.O = function (h) {
...
function oc() {
    ...
    "undefined" !== typeof document.documentElement.style[h] ? "webkitPerspective" in document.documentElement.style ? (h = document.createElement("style"), y = document.createElement("div"), k = document.head || document.getElementsByTagName("head")[0], h.textContent = "@media (-webkit-transform-3d) {#ggswhtml5{height:5px}}", k.appendChild(h),
        y.id = "ggswhtml5", document.documentElement.appendChild(y), k = 5 === y.offsetHeight, h.parentNode.removeChild(h), y.parentNode.removeChild(y)) : k = m : k = r;
    return k
}
...
function pano2vrPlayer(h) {
    ...
    function l(a) {
        for (var e = 0; e < p.length; e++)
            if (p[e].id == a) return p[e];
        for (e = 0; e < x.length; e++)
            if (x[e].id == a) return x[e];
        return o
    }
    ...
    function ma(a) {
        var e = -1;
        try {
            for (var c = 0; c < p.length; c++) p[c].id == a.id && p[c].obj != o && p[c].url.join() ==
                a.url.join() && p[c].loop == a.loop && p[c].mode == a.mode && (e = c);
            if (-1 == e) {
                for (c = 0; c < p.length; c++)
                    if (p[c].id == a.id && p[c].obj != o) {
                        try {
                            p[c].obj.pause()
                        } catch (f) {
                            X(f)
    ...
    function Ca() {
        ...
        if (Kb && (0 != ba || 0 != ca) && 0 > N) ba *= 0.9, ca *= 0.9, 0.1 > ba * ba + ca * ca ? ca = ba = 0 : (Jb(ba, ca),
            b.update());
        if (0 != Qa) {
            switch (Qa) {
            case 37:
        ...
        if (!b.isLoaded && b.hasConfig) {
            ...
            for (e = 0; e < b.checkLoaded.length; e++) b.checkLoaded[e].complete && "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAIAAABLbSncAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA5JREFUeNpiYBgeACDAAADIAAE3iTbkAAAAAElFTkSuQmCC" !=
                b.checkLoaded[e].src && c++;
        ...
        if (Ta) {
            ...
            if (e = a.getTime() - Wa, 0 < Pb && b.U &&
                e >= 1E3 * Pb) {
                if (1 < Xa.length) {
                    e = 1E3;
                    do c = Xa[Math.floor(Math.random() * Xa.length)]; while (e-- && c == Fb);
                    Wa = a.getTime();
                    b.openNext("{" + c + "}")
                }
        ...
        qc && (wb ? a.getTime() - Rb >= 1E3 * rc && (wb = r) : (ya += Ya, 0 > ya && (ya = 0, Ya = -Ya, wb = m,
            Rb = a.getTime()), 1 < ya && (ya = 1, Ya = -Ya, wb = m, Rb = a.getTime()), b.setOverlayOpacity(ya)));
        if (0 < x.length)
            for (e = 0; e < x.length; e++) x[e].ba && x[e].na != x[e].obj.currentTime && (x[e].na = x[e].obj.currentTime, !x[e].ha && 0 < x[e].obj.videoHeight && (x[e].ha = x[e].obj.videoWidth / x[e].obj.videoHeight));
        if (0 < P) {
            if (2 == P)
                for (e = 0; e < G.length; e++) a = G[e], "poly" == a.type && a.l != a.e && (a.l > a.e ? (a.e += 0.05, a.l < a.e && (a.e = a.l)) : (a.e -= 0.05, a.l > a.e && (a.e = a.l)), b.update());
    ...
    function Ia(a) {
        Za ||
            (X("setup gesture"), Za = new MSGesture, Za.target = b.control);
        Za.va(a.ya)
    }
    ...
    function Ka(a) {
		...
		{
			move = true;
			document.location.href = 'localhost:touchend';
		}
    }
    ...
    function La(a) {
		...
		if(Math.abs(dx) > 20 && move == true)
		{
			move = false;
			//document.location.href = 'localhost:touchmove';
		}
		
		if(out == true){
			out = false;
			//document.location.href = "loacalhost:clearimage";
    ...
    function na(a) {
        if (!Yb && (a = a ? a : window.event, a.target ==
            b.control)) {
    ...
    function Fc(a) {
        ...
        if (!S && (0 <= N && (a.preventDefault(), (a.which || 0 == a.which || 1 == a.which) && xc(a.pageX, a.pageY), E()), b.hotspot == b.emptyHotspot || "poly" == b.hotspot.type)) {
            ...
            b.hotspot != c && (b.hotspot != b.emptyHotspot && (0 < P && (b.hotspot.l = 0), b.skinObj && b.skinObj.hotspotProxyOut && b.skinObj.hotspotProxyOut(b.hotspot.id)),
                c ? (b.hotspot = c, b.skinObj && b.skinObj.hotspotProxyOver && b.skinObj.hotspotProxyOver(b.hotspot.id), C.style.cursor = "pointer", 0 < P && (ja = 1, b.hotspot.l = 1)) : (b.hotspot = b.emptyHotspot, C.style.cursor = "auto", 0 < P && (ja = 0)));
    ...
    function sc(a, e) {
        var c = Ab;
        c.enabled && (b.hotspot != b.emptyHotspot && 0 <= a && 0 <= e && "" != b.hotspot.title ? (I.innerHTML = b.hotspot.title, I.style.color = ra(c.Y, c.X), I.style.backgroundColor = c.background ? ra(c.u, c.t) : "transparent", I.style.border = "solid " + ra(c.z, c.v) + " " + c.R + "px",
    ...
    function Ic() {
        var a, e;
        if (W)
            for (; 0 < W.length;) g.deleteTexture(W.pop());
        W = [];
        for (var c = 0; 6 > c; c++) e = g.createTexture(), e.N = o, e.M = o, e.aa = r, g.bindTexture(g.TEXTURE_2D, e), g.texImage2D(g.TEXTURE_2D, 0, g.RGB, 1, 1, 0, g.RGB, g.UNSIGNED_BYTE, o), g.texParameteri(g.TEXTURE_2D,
            g.TEXTURE_MIN_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE), sa[c] && (a = new Image, a.crossOrigin = "anonymous", a.src = U(sa[c]), e.N = a, a.addEventListener && a.addEventListener("load", dc(e), r), b.checkLoaded.push(a)), W.push(e);
    ...
    function Gb() {
        ...
        for (e = 0; e < x.length + Na.length; e++) {
            ...
            0 < c.n && (h = c.n);
            0 < g && 0 < h && (c.obj.width =
                g + "px", c.obj.oa = h + "px", c.obj.style.width = g + "px", c.obj.style.oa = h + "px");
    ...
    function Tc(a) {
        ...
        do c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(l++)), f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(l++)),
        g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(l++)), h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(l++)), c = c << 2 | f >> 4, f = (f & 15) << 4 | g >> 2, d = (g & 3) << 6 | h, b += String.fromCharCode(c), 64 != g && (b += String.fromCharCode(f)), 64 != h && (b += String.fromCharCode(d));
        while (l < a.length);
        return b
    }
    ...
    function Vc(a, b) {
        ...
        var d = Ab;
        d.enabled && (c.text = document.createElement("div"), f = "position:absolute;" + ("left: -" + b.w / 2 + "px;"), f = f + "top:  20px;" + ("width: " + b.w + "px;"), f = 0 == b.h ? f + "height: auto;" : f + ("height: " + b.h + "px;"), b.wordwrap ? f = f + "white-space: pre-wrap;" + ("width: " + b.w + "px;") : (f = 0 == b.h ?
            ...
            0 < d.width ? d.width + "px" : "auto", c.text.style.height = 0 < d.height ? d.height + "px" : "auto", c.text.style.overflow = "hidden", c.text.innerHTML = b.title, c.__div.onmouseover = function () {
    ...
    b.getVFov = function () {
        ...
        case 2:
            a = 180 * Math.atan(z /
                Math.sqrt(A * A + z * z) * Math.tan(t / 2 * Math.PI / 180)) / Math.PI;
            break;
        case 3:
    ...
    b.updatePanorama = function () {
        ...
        for (d = 0; d < G.length; d++) {
            var h = G[d],
                l;
            "point" == h.type && (a.p(0, 0, -100), a.j(-h.tilt * Math.PI / 180), a.k(h.pan * Math.PI / 180), a.k(-s * Math.PI / 180), a.j(q * Math.PI / 180), c = r, 0.1 > a.b ? (l = -e / a.b, f = a.x * l, l *= a.y, Math.abs(f) < A / 2 + 500 && Math.abs(l) < z / 2 + 500 && (c = m)) : l = f = 0, h.obj && h.obj.__div && (h.obj.__div.style[ia] =
                "none", h.obj.ggUse3d ? c ? (Jc(e), h.obj.__div.style.width = "1px", h.obj.__div.style.height = "1px", hs = "", hs += "translate3d(0px,0px," + e + "px) ", hs += "rotateX(" + q.toFixed(10) + "deg) ", hs += "rotateY(" + (-s).toFixed(10) + "deg) ", hs += "rotateY(" + h.pan.toFixed(10) + "deg) ", hs += "rotateX(" + (-h.tilt).toFixed(10) + "deg) ", hs += "translate3d(0px,0px," + (-1 * h.obj.gg3dDistance).toFixed(10) + "px) ", h.obj.__div.style[fa + "Origin"] = "0% 0%", h.obj.__div.style[fa] = hs, h.obj.__div.style.left = Y + A / 2 + "px", h.obj.__div.style.top = aa + z / 2 + "px", h.obj.__div.style.visibility =
                    "visible") : (h.obj.__div.style[fa] = "", h.obj.__div.style.visibility = "hidden") : c ? (h.obj.__div.style.left = Y + f + A / 2 + "px", h.obj.__div.style.top = aa + l + z / 2 + "px") : (h.obj.__div.style.left = "-100px", h.obj.__div.style.top = "-100px")));
            if ("poly" == h.type) {
                ...
                0.1 > a.b ? (l = -e / a.b, f = A / 2 + a.x * l, l = z / 2 + a.y * l) : l = f = 0, a.F = f, a.r = l;
                h.q = n
            }
        }
        if (T && (ic != P && (ic = P, T.style.visibility = 0 < P ? "inherit" : "hidden"), 0 < P)) {
            ...
            for (e = 0; e < G.length; e++)
                if (d = G[e], "poly" == d.type && (h = d.q, 2 == P && (a = d.e), Q.fillStyle = ra(d.u, d.t * a), Q.strokeStyle = ra(d.z, d.v * a), 0 < h.length)) {
                    Q.beginPath();
        ...
        if (db) {
            ...
            if (g) {
                ...
                for (v = 0; 6 > v; v++) qb(eb), nc(eb, -q * Math.PI / 180, [1, 0, 0]), nc(eb, (180 - s) * Math.PI / 180, [0, 1, 0]), 4 > v ? nc(eb, -Math.PI / 2 * v, [0, 1, 0]) : nc(eb, Math.PI / 2 * (5 == v ? 1 : -1), [1, 0, 0]), g.bindBuffer(g.ARRAY_BUFFER, ac), g.vertexAttribPointer(D.ea, 3, g.FLOAT, r, 0, 0), g.bindBuffer(g.ARRAY_BUFFER, bc), g.vertexAttribPointer(D.da, 2, g.FLOAT, r, 0, 0), 6 <= W.length && (g.activeTexture(g.TEXTURE0), g.bindTexture(g.TEXTURE_2D, W[v]), g.bindBuffer(g.ELEMENT_ARRAY_BUFFER, cc), g.uniform1i(D.ta, 0), g.uniformMatrix4fv(D.ra, r, eb),
                    g.uniformMatrix4fv(D.ca, r, Db), g.drawElements(g.TRIANGLES, 6, g.UNSIGNED_SHORT, 0))
            }
        } else {
            Bb();
            e = r;
            ...
            if (ha && la) ha.style[fa] = "translate3d(" + A / 2 + "px," + z / 2 + "px," + a + "px)", la.style[fa] = "rotateX(" + Number(q).toFixed(10) + "deg)  rotateY(" + Number(-s).toFixed(10) + "deg)";
                ...
                for (e = 0; 6 > e; e++)
                    if (d = b.cubeFaces[e]) h =
                        "translate3d(" + A / 2 + "px," + z / 2 + "px," + a + "px) ", h += "rotateX(" + Number(q).toFixed(10) + "deg)  rotateY(" + Number(-s).toFixed(10) + "deg) ", d.$ && (h += d.$, d.style.transform = h)
        }
        Gb()
    };
    var D;
    ...
    b.ia = function () {
        ...
        a.addEventListener ? (a.addEventListener("touchstart", Ma, r), a.addEventListener("touchmove", La, r), a.addEventListener("touchend", Ka, r), a.addEventListener("touchcancel", Ja, r), a.addEventListener("MSPointerDown", Ia, r), a.addEventListener("MSGestureStart", wa, r), a.addEventListener("MSGestureEnd", Ha, r), a.addEventListener("MSGestureChange",
            ...
            Fa), window.attachEvent("onresize", za), window.attachEvent("onblur", Ea));
        a.oncontextmenu = function (a) {
            void 0 === a && (a = window.event);
            return !a.ctrlKey && (a = "<<L>>", "U" != a.charAt(2)) ? (Aa(), r) : m
        }
    };
    b.addHotspotElements = function () {
        for (var a = 0; a < G.length; a++)
            if ("point" == G[a].type && (G[a].obj = b.skinObj && b.skinObj.addSkinHotspot ? new b.skinObj.addSkinHotspot(G[a]) : new Vc(this, G[a]), G[a].obj && G[a].obj.__div)) {
                var e = C.firstChild;
    ...
    b.isPlaying = function (a) {
        return "_main" ==
            a ? m : (a = l(a)) ? !a.obj.ended && !a.obj.paused : r
    };
    ...
    b.stopSound = function (a) {
        if ("_main" == a) {
            for (a = 0; a < p.length; a++) p[a].obj.pause(), p[a].obj.currentTime =
                0;
    ...
    b.changeVolume = function (a, b) {
        if ("_main" == a) {
            ...
            var f = l(a);
            f && (c =
                f.c, c += Number(b), 1 < c && (c = 1), 0 > c && (c = 0), f.c = c, f.obj.volume = c * R)
        }
    };
    ...
    b.createLayers = function (a) {
        ...
        b.B ? (b.B.innerHTML = "", b.a = document.createElement("div"), b.a.setAttribute("style", "top:  0px;left: 0px;position:relative;-ms-touch-action: none;"), b.B.appendChild(b.a), F = document.createElement("div"), a = "top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;z-index: 0;" + (M + "user-select: none;"), F.setAttribute("style", a), b.a.appendChild(F), C = document.createElement("div"), a = "top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;z-index: 1000;",
            ...
            I.innerHTML = " Hotspot text!", b.a.appendChild(I), b.divSkin = C) : alert("container not found!")
    };
    ...
    b.ka = function () {
        ...
        for (c = 0; 6 > c; c++) {
            ...
            d +=
                " scale(" + bb + ") translate3d(" + -f / 2 + "px," + -f / 2 + "px," + -f / 2 + "px)";
            a += d + ";";
            e.$ = d;
    ...
    b.finalPanorama = function () {
        var a;
        if (Cb)
            for (a = 0; 6 > a; a++) b.cubeFaces[a].setAttribute("src", U(ab[a]))
    };
    b.setOverlayOpacity = function (a) {
        var e;
        if (Cb)
            for (e = 0; 6 > e; e++) b.cubeFacesOverlay[e] && b.cubeFacesOverlay[e].style && (b.cubeFacesOverlay[e].style.opacity = a)
    };
    b.removePanorama = function () {
        var a;
        if (Cb) {
            for (a = 0; a < b.cubeFaces.length; a++) b.cubeFaces[a].setAttribute("src",
    ...
    b.W = function (a, e) {
        ...
        for (var c = a.firstChild, f, d, h, l = 1E6; c;) {
            if ("view" == c.nodeName) {
                ...
                for (f = c.firstChild; f;) "start" == f.nodeName && (d = f.getAttributeNode("pan"), jc = s = Number(d ? d.nodeValue : 0), d = f.getAttributeNode("tilt"), kc = q = Number(d ? d.nodeValue : 0), d =
                    f.getAttributeNode("fov"), vb = t = Number(d ? d.nodeValue : 70)), "min" == f.nodeName && (d = f.getAttributeNode("pan"), Va = 1 * (d ? d.nodeValue : 0), d = f.getAttributeNode("tilt"), ua = 1 * (d ? d.nodeValue : -90), d = f.getAttributeNode("fov"), ea = 1 * (d ? d.nodeValue : 5), 1.0E-8 > ea && (ea = 1.0E-8)), "max" == f.nodeName && (d = f.getAttributeNode("pan"), Ua = 1 * (d ? d.nodeValue : 0), d = f.getAttributeNode("tilt"), ta = 1 * (d ? d.nodeValue : 90), d = f.getAttributeNode("fov"), da = 1 * (d ? d.nodeValue : 120), 180 <= da && (da = 179.9)), f = f.nextSibling
            }
            if ("autorotate" == c.nodeName && ((d =
                c.getAttributeNode("speed")) && (qa = 1 * d.nodeValue), (d = c.getAttributeNode("delay")) && (Qb = 1 * d.nodeValue), (d = c.getAttributeNode("returntohorizon")) && (ub = 1 * d.nodeValue), (d = c.getAttributeNode("nodedelay")) && (Pb = 1 * d.nodeValue), Eb && 0 != qa && (V = Sa = m, Wa = (new Date).getTime()), d = c.getAttributeNode("startloaded")))(sb = 1 == d.nodeValue) && (V = r);
            "input" == c.nodeName && (h || (h = c));
            if (h)
                for (f = 0; 6 > f; f++) d = h.getAttributeNode("prev" + f + "url"), sa[f] = d ? new String(d.nodeValue) : "";
            "altinput" == c.nodeName && (f = 0, (d = c.getAttributeNode("screensize")) &&
                (f = 1 * d.nodeValue), 0 < f && f >= b.getMaxScreenResolution() && f < l && (l = f, h = c));
            "control" == c.nodeName && Eb && ((d = c.getAttributeNode("simulatemass")) && (Kb = 1 == d.nodeValue), (d = c.getAttributeNode("locked")) && (S = 1 == d.nodeValue), d && (xb = 1 == d.nodeValue), (d = c.getAttributeNode("lockedmouse")) && (S = 1 == d.nodeValue), (d = c.getAttributeNode("lockedkeyboard")) && (xb = 1 == d.nodeValue), (d = c.getAttributeNode("lockedwheel")) && (Yb = 1 == d.nodeValue), (d = c.getAttributeNode("invertwheel")) && (Ac = 1 == d.nodeValue), (d = c.getAttributeNode("speedwheel")) &&
                (Bc = 1 * d.nodeValue), (d = c.getAttributeNode("invertcontrol")) && (xa = 1 == d.nodeValue), (d = c.getAttributeNode("dblclickfullscreen")) && (Ub = 1 == d.nodeValue));
            ...
            if ("hotspots" == c.nodeName)
                for (f = c.firstChild; f;) {
                    if ("label" == f.nodeName) {
                        var n = Ab;
                        if (d = f.getAttributeNode("enabled")) n.enabled =
                            1 == d.nodeValue;
                        ...
                        if (d = f.getAttributeNode("bordercolor")) n.z =
                            1 * d.nodeValue;
                    ...
                    "hotspot" == f.nodeName && (n = {
                            ...
                            obj: o,
                            I: o
                        }, d = f.getAttributeNode("pan"), n.pan = 1 * (d ? d.nodeValue : 0), d = f.getAttributeNode("tilt"), n.tilt = 1 * (d ? d.nodeValue : 0), (d = f.getAttributeNode("url")) && (n.url = d.nodeValue.toString()), (d = f.getAttributeNode("target")) && (n.target = d.nodeValue.toString()), (d = f.getAttributeNode("title")) && (n.title = d.nodeValue.toString()), (d = f.getAttributeNode("id")) && (n.id = d.nodeValue.toString()), (d = f.getAttributeNode("skinid")) &&
                        (n.skinid = d.nodeValue.toString()), (d = c.getAttributeNode("width")) && (n.w = d.nodeValue.toString()), (d = c.getAttributeNode("height")) && (n.h = d.nodeValue.toString()), (d = c.getAttributeNode("wordwrap")) && (n.wordwrap = 1 == d.nodeValue), G.push(n));
                    if ("polyhotspot" == f.nodeName) {
                        ...
                        (d = f.getAttributeNode("title")) &&
                            (n.title = d.nodeValue.toString());
            ...
            if ("sounds" == c.nodeName || "media" == c.nodeName)
                for (f = c.firstChild; f;) {
                    if ("sound" == f.nodeName) {
                        ...
                        if (d = f.getAttributeNode("mode")) k.mode =
                            Number(d.nodeValue);
                    ...
                    if ("video" == f.nodeName) {
                        ...
                        if (d = f.getAttributeNode("field")) k.field = Number(d.nodeValue);
                        if (d = f.getAttributeNode("ambientlevel")) k.A =
                            Number(d.nodeValue);
                        if (d = f.getAttributeNode("pan")) k.pan = Number(d.nodeValue);
                        if (d = f.getAttributeNode("tilt")) k.tilt = Number(d.nodeValue);
                        if (d = f.getAttributeNode("pansize")) k.g = Number(d.nodeValue);
                        ...
                        if (d = f.getAttributeNode("width")) k.o =
                            Number(d.nodeValue);
        ...
        if (h) {
            for (f = 0; 6 > f; f++)(d = h.getAttributeNode("tile" + f + "url")) && (ab[f] = new String(d.nodeValue)),
            d = h.getAttributeNode("tile" + f + "url1"), mc[f] = d ? new String(d.nodeValue) : "";
    ...
    b.openUrl = function (a, e) {
        0 < a.length && (".xml" == a.substr(a.length -
            4) || ".swf" == a.substr(a.length - 4) || "{" == a.charAt(0) ? b.openNext(U(a), e) : window.open(U(a), e))
    };
    b.openNext = function (a, e) {
        ...
        if ("{" == a.charAt(0))
            if (f = a.substr(1, a.length - 2), cb[f]) b.W(cb[f], c), k(a);
            else {
                X("invalid node id: " + f);
                return
